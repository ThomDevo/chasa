...
@NamedQueries(value = {
        ...
        @NamedQuery(name = "Event.SelectEventById", query="SELECT e from EventsEntity e  JOIN DiveSiteCharacteristicsEntity dsc ON (e.diveSitesByIdDiveSite.idDiveSite = dsc.diveSitesByIdDiveSite.idDiveSite)where e.idEvent = :idEvent"),
})
